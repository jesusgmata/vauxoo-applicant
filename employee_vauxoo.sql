...
CREATE TABLE employee (
    ...
    boss_name character varying(255) COLLATE pg_catalog."default",
  ...
  INSERT INTO employee VALUES ('1112','Humberto','Ramirez','leer y gym',NULL);
  INSERT INTO employee VALUES ('1113','Maritza','Gutierrez','leer y gym','Humberto Ramirez');
  INSERT INTO employee VALUES ('1114','Felipe','Hernandez','gym y football','Humberto Ramirez');
  INSERT INTO employee VALUES ('1115','Cecilia','Contreras','leer y gym','Humberto Ramirez');
  ...
  UPDATE employee
  SET boss_name = 'Humberto Ramirez'
  WHERE employee_id = 1046;
  ...
  UPDATE employee
  SET boss_name = 'Felipe Hernandez'
  WHERE employee_id = 1087;
  
  UPDATE employee
  SET boss_name = 'Maritza Gutierrez'
  WHERE employee_id = 1076;
